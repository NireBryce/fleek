 ...
 nixpkgs = {
  ...
  programs = { 
    ...
    programs.vscode = { # https://github.com/nix-community/home-manager/blob/master/modules/programs/vscode.nix
      ...
      haskell.enable = false; # haskell integration
      haskell.hie.enable = false; # haskell IDE engine
      # haskell.hie.executablePath = (import ~/src/haskell-ide-engine {}).hies + "/bin/hie-wrapper";
